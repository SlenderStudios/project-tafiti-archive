...
namespace WLQuickApps.ContosoBicycleClub.UI
{
    ...
    public partial class WindowsLiveLogin
    {
        ...
        public WindowsLiveLogin(bool loadAppSettings)
        {
            ...
            RefreshUrl = appSettings["wll_refreshurl"];
            AppUrl = appSettings["wll_appurl"];
            MailHost = appSettings["mail_host"];
            MailFrom = appSettings["mail_from"];
            MailSubject = appSettings["mail_subject"];
        }
        ...
        public WindowsLiveLogin(string settingsFile)
        {
            ...
            RefreshUrl = settings["wll_refreshurl"];
            AppUrl = settings["wll_appurl"];
        ...
        public string AppUrl
        {
            ...
            get
            {
                if (string.IsNullOrEmpty(policyUrl))
                {
                    if (ForceDelAuthNonProvisioned)
                    {
                        throw new InvalidOperationException("Error: AppUrl: App URL must be set in a Delegated Auth scenario. Aborting.");
                    }
                }
                return appUrl;
            }
        ...
        public string RefreshUrl
        {
            ...
            get
            {
                ...
                {
                    return "https://consent.live.com/RefreshToken.aspx/";
                }
        ...
        /// <summary>
        /// Sets or gets the SMTP mail host.
        /// </summary>
        ...
        /// <summary>
        /// Sets or gets the mail from email address.
        /// </summary>
        ...
        /// <summary>
        /// Sets or gets the mail subject text.
        /// </summary>
        ...
        public string GetConsentUrl(string offers, string context, string ru, string market)
        {
            ...
            string appurl = "&AppUrl=" + HttpUtility.UrlEncode(AppUrl);

            return (ConsentUrl + offers + context + ru + pu + market + app + appurl);
        }
        ...
        public string GetRefreshConsentTokenUrl(string offers, string refreshToken, string delToken)
        {
            return GetRefreshConsentTokenUrl(offers, refreshToken, delToken, null);
        }
        ...
        /// overridden by 'ru' specified here.</param>
        /// <returns>Refresh consent token URL</returns>
        public string GetRefreshConsentTokenUrl(string offers, string refToken, string delToken, string ru)
        {
            if (string.IsNullOrEmpty(offers))
            {
            ...
            string refreshToken = "&reft=" + refToken;
            if (string.IsNullOrEmpty(ru))
            {
                ru = ReturnUrl;
            }

            ru = string.IsNullOrEmpty(ru) ? string.Empty : "&ru=" + HttpUtility.UrlEncode(ru);

            string delt = string.Empty;
            if (string.IsNullOrEmpty(delt))
            {
                delt = "&delt=" + delToken;
            }

            return RefreshUrl + offers + refreshToken + ru + delt;
        }
