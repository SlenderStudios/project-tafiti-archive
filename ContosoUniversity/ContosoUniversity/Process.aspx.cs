...
namespace ContosoUniversity
{
    public partial class Process : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(appctx))
            {
                appctx = "~/Default.aspx";
            }

            HyperLink1.NavigateUrl = "http://" + Request.Url.Host + "/default.aspx";
            ...
            */
            ...
            else if (action == "delauth")
            {
                ...
                Label1.Text = "Thank you. The request to read your Windows Live Contacts has been approved.";
            }
            else
            {
                System.Collections.Specialized.NameValueCollection postedValues = Request.Form;
                string responseCode = postedValues["ResponseCode"];
                Label1.Text = string.Format("The request to read your Window Live Contacts has been rejected (Reason:{0}). You may continue, but your contacts will not be available on this web site.", responseCode);
            }
        }
    }
}