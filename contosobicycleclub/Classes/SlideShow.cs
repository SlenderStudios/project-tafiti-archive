...
public class SlideShow
{
    public static AjaxControlToolkit.Slide[] GetSlides(string request)
    {
        ...
        foreach (XmlNode xmlNode in xmlNodeList)
        {
            ...
            string description = xmlNode.ParentNode.FirstChild.InnerText;
            
            // Add the slide (URI to IMAGE, NAME (using Description), DESCRIPTION)
            slides.Add(new AjaxControlToolkit.Slide(xmlNode.Attributes["url"].Value, description, description));
        }
