...
namespace WLQuickApps.SocialNetwork.Data {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("WebEventDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class WebEventDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        protected WebEventDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            WebEventDataSet cln = ((WebEventDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "WebEventDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/WebEventDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            WebEventDataSet ds = new WebEventDataSet();
        ...
        public partial class aspnet_WebEvent_EventsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public aspnet_WebEvent_EventsRow Addaspnet_WebEvent_EventsRow(string EventId, System.DateTime EventTime, string EventType, string Message, string ApplicationPath, string ApplicationVirtualPath, string MachineName, string RequestUrl, string ExceptionType, string Details) {
        ...
        public partial class aspnet_WebEvent_EventsRow : global::System.Data.DataRow {
            ...
            public string ApplicationVirtualPath {
                get {
                    if (this.IsApplicationVirtualPathNull()) {
                        return string.Empty;
                    }
                    else {
...
namespace WLQuickApps.SocialNetwork.Data.WebEventDataSetTableAdapters {
    ...
    public partial class aspnet_WebEvent_EventsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [aspnet_WebEvent_Events] SET [EventId] = @EventId, [EventTime] = @EventTime, [EventType] = @EventType, [Message] = @Message, [ApplicationPath] = @ApplicationPath, [ApplicationVirtualPath] = @ApplicationVirtualPath, [MachineName] = @MachineName, [RequestUrl] = @RequestUrl, [ExceptionType] = @ExceptionType, [Details] = @Details WHERE (([EventId] = @Original_EventId) AND ([EventTime] = @Original_EventTime) AND ([EventType] = @Original_EventType) AND ((@IsNull_Message = 1 AND [Message] IS NULL) OR ([Message] = @Original_Message)) AND ((@IsNull_ApplicationPath = 1 AND [ApplicationPath] IS NULL) OR ([ApplicationPath] = @Original_ApplicationPath)) AND ((@IsNull_ApplicationVirtualPath = 1 AND [ApplicationVirtualPath] IS NULL) OR ([ApplicationVirtualPath] = @Original_ApplicationVirtualPath)) AND ([MachineName] = @Original_MachineName) AND ((@IsNull_RequestUrl = 1 AND [RequestUrl] IS NULL) OR ([RequestUrl] = @Original_RequestUrl)) AND ((@IsNull_ExceptionType = 1 AND [ExceptionType] IS NULL) OR ([ExceptionType] = @Original_ExceptionType)));
SELECT EventId, EventTime, EventType, Message, ApplicationPath, ApplicationVirtualPath, MachineName, RequestUrl, ExceptionType, Details FROM aspnet_WebEvent_Events WHERE (EventId = @EventId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EventId, EventTime, EventType, Message, ApplicationPath, ApplicationVirtua" +
                "lPath, MachineName, RequestUrl, ExceptionType, Details FROM aspnet_WebEvent_Even" +
                "ts";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT EventId, EventTime, EventType, Message, ApplicationPath, ApplicationVirtua" +
                "lPath, MachineName, RequestUrl, ExceptionType, Details FROM aspnet_WebEvent_Even" +
                "ts WHERE (EventId = @eventID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@eventID", global::System.Data.SqlDbType.Char, 32, global::System.Data.ParameterDirection.Input, 0, 0, "EventId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT COUNT(*) FROM aspnet_WebEvent_Events";
...
where RowID between (@startRowIndex + 1) and (@startRowIndex + @maximumRows)";
        ...
        public virtual int Fill(WebEventDataSet.aspnet_WebEvent_EventsDataTable dataTable) {
        ...
        public virtual WebEventDataSet.aspnet_WebEvent_EventsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            WebEventDataSet.aspnet_WebEvent_EventsDataTable dataTable = new WebEventDataSet.aspnet_WebEvent_EventsDataTable();
        ...
        public virtual WebEventDataSet.aspnet_WebEvent_EventsDataTable GetWebEventByEventID(string eventID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((eventID == null)) {
                throw new global::System.ArgumentNullException("eventID");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(eventID));
            }
            WebEventDataSet.aspnet_WebEvent_EventsDataTable dataTable = new WebEventDataSet.aspnet_WebEvent_EventsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual WebEventDataSet.aspnet_WebEvent_EventsDataTable GetWebEvents(int startRowIndex, int maximumRows) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(WebEventDataSet.aspnet_WebEvent_EventsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(WebEventDataSet dataSet) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> GetWebEventCount() {
