...
function openIMWindow(emailHash)
{
    ...
    {
        emailHashesToWindows[emailHash] = window.open("IMWindow.aspx?emailHash=" + emailHash, emailHash, "width=420;height=500;location=no;menubar=no;status=no;directories=no;");
    }
    else
    {
