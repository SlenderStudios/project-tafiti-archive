...
<body onload="onLoad()" onunload="closeIM()" style="background:#08254c url(images/background.jpg) no-repeat; text-align:center;">
    ...
    <div id="framing" style="width:400px; max-height:600px;text-align:left;background-color:#FFF;">
        ...
        <div id="inputSpace" style="background-color:#FFF; width: 100%; border-top: solid 1px #9eb6c0">
            ...
            <div id="send" onclick="sendMessage()" style="background: url(images/send.png) no-repeat #FFF bottom right; width:58px;height:80px; cursor:hand; float: left;" />
        </div>
    </div>    
</body>
</html>
